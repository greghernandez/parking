...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-12-2017 a las 02:23:10
...
INSERT INTO `cliente` (`id_cliente`, `nombre`, `apellido`, `correo`, `password`, `telefono`, `estado`, `municipio`, `cp`, `rfc`, `direccion`) VALUES
(2, 'luis', 'montes', 'luis@gmail.com', 0x1234, 1234567891, 'sdscd', 'sdaasas', 123456, 0x1322, '');
...
ALTER TABLE `realiza_est`
  ...
  ADD CONSTRAINT `realiza_est_ibfk_2` FOREIGN KEY (`id_pago`) REFERENCES `pago_est` (`id_pago`);
...
ALTER TABLE `realiza_parq`
  ...
  ADD CONSTRAINT `realiza_parq_ibfk_2` FOREIGN KEY (`id_pago`) REFERENCES `pago_parq` (`id_pago`);
